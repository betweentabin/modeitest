  ...
  <div class="group-27">
    <div class="group-11">
      <div class="group-8">
        <img
          class="ico_logo-1"
          src="https://cdn.animaapp.com/projects/68131d325b4f63697a4e5f8d/releases/687f21920f7550798ae31b24/img/ico-logo-1-1.svg"
          alt="ico_logo 1"
        />
        <view3 />
      </div>
      <div class="x839-0864 valign-text-middle">
        〒839-0864　福岡県久留米市百年公園1番1号 久留米リサーチセンタービル6階<br />電話番号. 0942-46-5081　営業時間.
        平日9:00-17:00
      </div>
    </div>
