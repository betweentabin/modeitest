    ...
    <section class="form-section" v-if="!isEditPreview">
      <div class="form-container">
        ...
        <form class="contact-form" @submit.prevent="submitForm">
          ...
          <!-- Terms Section (CMS from transaction-law) -->
          <div class="terms-section">
            <div class="terms-content">
              <div class="terms-article">
                <h3 class="terms-title"><CmsText pageKey="contact" fieldKey="article1_title" tag="span" :fallback="'第1条(目的）'" /></h3>
                <p class="terms-text"><CmsText pageKey="contact" fieldKey="article1_body" tag="span" :fallback="'「ちくぎん地域経済クラブ」（以下、「本会」という）は、株式会社ちくぎん地域経済研究所（以下、「当社」という）が運営するサービスであり、産・官・学・金（金融機関）のネットワーク構築や会員相互の交流等を通じて、企業経営等に役立つ様々な情報や機会提供により、会員企業等がともに発展し、ひいては地域の振興・発展に寄与することを目的とします。'" /></p>
              </div>

              <div class="terms-article">
                <h3 class="terms-title"><CmsText pageKey="contact" fieldKey="article2_title" tag="span" :fallback="'第2条(会員）'" /></h3>
                <p class="terms-text"><CmsText pageKey="contact" fieldKey="article2_body" tag="div" type="html" :fallback="'本規約を了承のうえ当社所定の形式により入会の手続きをされた法人およびそれに準ずる団体、個人事業主または個人のうち、当社が会員入会を承認した方を本会の会員とします（以下、会員入会を承認した法人およびそれに準ずる団体または個人事業主の方を「法人会員」、会員入会を承認した個人の方を「個人会員」という）。なお、法人会員は、複数口の入会が可能です。<br>会員は、会員資格を第三者に利用させたり、貸与、譲渡、売買、質入等をすることはできないものとします。'" /></p>
              </div>

              <div class="terms-article">
                <h3 class="terms-title"><CmsText pageKey="contact" fieldKey="article3_title" tag="span" :fallback="'第3条(会員種別および会員サービス）'" /></h3>
                <p class="terms-text"><CmsText pageKey="contact" fieldKey="article3_body" tag="span" :fallback="'本会の会員は、スタンダード会員とプレミアムネット会員の2種類とし、その会員種別に応じた次のサービス（以下、「会員サービス」という）を利用できるものとします。'" /></p>

                <h4 class="service-title"><CmsText pageKey="contact" fieldKey="standard_title" tag="span" :fallback="'【スタンダード会員】'" /></h4>
                <div class="service-item">
                  <span class="service-number">①</span>
                  <span class="service-text"><CmsText pageKey="contact" fieldKey="standard_item1" tag="span" :fallback="'機関誌「ちくぎん地域経済レポート」等、当社が発行する刊行物並びにダイレクトメール、E-Mail等による経済、産業、企業動向等、企業経営に役立つ情報サービス'" /></span>
                </div>
                <div class="service-item">
                  <span class="service-number">②</span>
                  <span class="service-text"><CmsText pageKey="contact" fieldKey="standard_item2" tag="span" :fallback="'各種の経営相談に対する課題解決に向けた提案（相談の内容によっては有料）'" /></span>
                </div>
                <div class="service-item">
                  <span class="service-number">③</span>
                  <span class="service-text"><CmsText pageKey="contact" fieldKey="standard_item3" tag="span" :fallback="'当社主催の各種セミナー、企画、イベント等の割引料金による案内'" /></span>
                </div>
                <div class="service-item">
                  <span class="service-number">④</span>
                  <span class="service-text"><CmsText pageKey="contact" fieldKey="standard_item4" tag="span" :fallback="'当社が運営するインターネットサイト（スタンダード会員サイト）の利用'" /></span>
                </div>

                <h4 class="service-title"><CmsText pageKey="contact" fieldKey="premium_title" tag="span" :fallback="'【プレミアムネット会員】'" /></h4>
                <p class="service-subtitle"><CmsText pageKey="contact" fieldKey="premium_intro" tag="span" :fallback="'スタンダード会員が利用できる上記①から④までのサービスに加えて'" /></p>
                <div class="service-item">
                  <span class="service-number">⑤</span>
                  <span class="service-text"><CmsText pageKey="contact" fieldKey="premium_item5" tag="span" :fallback="'プレミアムネット会員専用インターネットサイト（販路拡大等を目的としたビジネスマッチングサービスを含む）による企業経営に役立つ各種ビジネス情報の提供'" /></span>
                </div>
                <div class="service-item">
                  <span class="service-number">⑥</span>
                  <span class="service-text"><CmsText pageKey="contact" fieldKey="premium_item6" tag="span" :fallback="'会員企業PR情報掲載サービス'" /></span>
                </div>
                <div class="service-item">
                  <span class="service-number">⑦</span>
                  <span class="service-text"><CmsText pageKey="contact" fieldKey="premium_item7" tag="span" :fallback="'日経BP発刊「日経トップリーダー」の送付。同社主催の「日経トップリーダー 経営セミナー」の案内'" /></span>
                </div>
              </div>
            </div>
            ...
            <div class="terms-download">
              <a href="/pdf/chikugin_kiyaku2.pdf" class="download-link" target="_blank">
                <CmsText pageKey="contact" fieldKey="terms_download_label" tag="span" :fallback="'会員規約をPDFでダウンロード'" />
