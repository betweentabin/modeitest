<template>
  <div class="privacy-policy-page">
    ...
    <div class="breadcrumbs">
      ...
      <span class="breadcrumb-item current">プライバシーポリシー</span>
    </div>
    ...
    <div class="main-content">
      ...
      <div class="content-container">
        ...
        <div class="policy-section">
          <h3 class="section-title">個人情報を収集・利用��る目的</h3>
        ...
        <div class="policy-section">
          <h3 class="section-title">適切な取得</h3>
          <p class="section-content">
            当研究所サイトを利用された場合、お客様はプライバシーポリシーに同意して頂いたものと判断いたします。諸事情により、上記のプライバシーポリシーを部分的に変更、修正、 追加、削除させて頂くことがご���います。加えて、プライバシーポリシーについては、変更等のご連絡をお客様にご連絡することはありません。随時、このページにてご確認ください。
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="fixed-side-buttons">
      <button class="side-button login-side">
      ...
      <button class="side-button contact-side">
