      ...
      <div class="form-container">
        ...
        <form class="contact-form" @submit.prevent="submitForm">
          ...
          <div class="form-field">
            <label class="field-label">セミナー情報</label>
            <div class="field-input">
              <div class="seminar-info">
                <h4 class="seminar-title">{{ seminarTitle }}</h4>
                <p class="seminar-date">{{ seminarDate }}</p>
                <p class="seminar-location">{{ seminarLocation }}</p>
              </div>
            </div>
          </div>
          ...
          <div class="form-field">
            ...
            <div class="field-input">
              <select v-model="formData.attendanceType" class="select-field">
          ...
          <div class="form-field">
            ...
            <div class="field-input">
              <textarea v-model="formData.specialRequests" class="textarea-input" placeholder="特別なご要望や備考がございましたらご記入ください"></textarea>
            </div>
          </div>
...
export default {
  ...
  computed: {
    canSubmit() {
      return this.formData.attendanceType &&
  ...
  methods: {
    async submitForm() {
      ...
      this.$router.push(`/seminar/application/confirm?formData=${formDataParam}`);
    },
