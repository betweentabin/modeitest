...
const RECOMMENDED_KEYS = {
  ...
  contact: [
    'page_title', 'page_subtitle', 'form_title',
    'form_label_subject', 'form_placeholder_select',
    'form_option_inquiry', 'form_option_membership', 'form_option_seminar', 'form_option_other',
    'form_label_name', 'form_label_kana', 'form_label_company', 'form_label_position',
    'form_label_phone', 'form_label_email', 'form_label_content',
    'form_privacy_note', 'form_privacy_agree', 'form_button_confirm',
    'contact_title', 'contact_label', 'contact_subtitle', 'contact_cta'
  ],
  'membership-application': [
    'page_title', 'page_subtitle', 'form_title',
    'form_label_subject', 'form_placeholder_select',
    'form_option_standard', 'form_option_premium', 'form_option_inquiry', 'form_option_other',
    'form_label_name', 'form_label_kana', 'form_label_company', 'form_label_position',
    'form_label_phone', 'form_label_email', 'form_label_content',
    'terms_article2_title', 'terms_article2_body',
    'terms_article3_title', 'terms_article3_intro',
    'standard_title', 'standard_item1', 'standard_item2', 'standard_item3', 'standard_item4',
    'premium_title', 'premium_intro', 'premium_item5', 'premium_item6', 'premium_item7',
    'terms_download_label',
    'form_privacy_note', 'form_privacy_agree', 'form_button_confirm'
  ],
  'seminar-application': [
    'page_title', 'page_subtitle', 'form_title',
  ...
  navigation: [
    'nav_about', 'nav_seminars', 'nav_publications', 'nav_information',
    'nav_membership', 'nav_premium_benefits', 'nav_news', 'nav_company', 'nav_faq',
    'nav_indicators', 'nav_statistics', 'nav_membership_standard', 'nav_membership_premium'
  ],
  footer: [
    'link_home', 'link_company', 'link_about', 'link_news', 'link_faq', 'link_contact',
    'link_seminar', 'link_publication', 'link_glossary',
    'link_membership', 'link_membership_standard', 'link_membership_premium', 'link_cri_consulting',
    'link_member_login', 'link_legal', 'link_privacy', 'link_terms', 'link_sitemap'
  ]
}
...
const TEXT_LIMITS = {
  ...
  form_privacy_note: 200,
  form_privacy_agree: 40,
  form_button_confirm: 24,
  terms_download_label: 60,
  standard_title: 40,
  premium_title: 40,
}
...
const KEY_HELP = {
  ...
  form_privacy_note: { label: '規約案内文', desc: 'チェックボックスの上に表示される案内文', placeholder: '弊社のプライバシーポリシーに同意をされる場合は…' },
  form_privacy_agree: { label: '規約同意ラベル', desc: 'チェックボックス横の文言', placeholder: '個人情報保護方針に同意します' },
  form_button_confirm: { label: 'フォーム送信ボタン', desc: '送信ボタンに表示する文言', placeholder: '確認する' },
  terms_download_label: { label: '規約PDFリンク', desc: '規約PDFダウンロードリンクのテキスト', placeholder: '会員規約をPDFでダウンロード' },
  terms_article2_title: { label: '条文見出し（第2条）', desc: '規約本文の見出しを編集します', placeholder: '第2条（会員）' },
  terms_article2_body: { label: '条文本文（第2条）', desc: '規約の本文（HTML可）', placeholder: '本規約を了承のうえ…' },
  terms_article3_title: { label: '条文見出し（第3条）', desc: '規約本文の見出しを編集します', placeholder: '第3条（会員種別および会員サービス）' },
  terms_article3_intro: { label: '条文導入（第3条）', desc: '条文前の説明文', placeholder: '本会の会員は、スタンダード会員と…' },
  standard_title: { label: 'スタンダード会員見出し', desc: 'スタンダード会員向けサービスの見出し', placeholder: '【スタンダード会員】' },
  standard_item1: { label: 'スタンダード項目①', desc: '箇条書きの本文', placeholder: '機関誌「ちくぎん地域経済レポート」等…' },
  standard_item2: { label: 'スタンダード項目②', desc: '箇条書きの本文', placeholder: '各種の経営相談に対する課題解決…' },
  standard_item3: { label: 'スタンダード項目③', desc: '箇条書きの本文', placeholder: '当社主催の各種セミナー…' },
  standard_item4: { label: 'スタンダード項目④', desc: '箇条書きの本文', placeholder: '当社が運営するインターネットサイトの利用' },
  premium_title: { label: 'プレミアム会員見出し', desc: 'プレミアム会員向けサービスの見出し', placeholder: '【プレミアムネット会員】' },
  premium_intro: { label: 'プレミアム会員導入文', desc: 'スタンダードとの違い説明', placeholder: 'スタンダード会員が利用できる…' },
  premium_item5: { label: 'プレミアム項目⑤', desc: '箇条書きの本文', placeholder: 'プレミアムネット会員専用インターネットサイト…' },
  premium_item6: { label: 'プレミアム項目⑥', desc: '箇条書きの本文', placeholder: '会員企業PR情報掲載サービス' },
  premium_item7: { label: 'プレミアム項目⑦', desc: '箇条書きの本文', placeholder: '日経トップリーダーの送付…' },
  nav_about: { label: 'ヘッダーナビ：私たちについて', desc: 'ヘッダーメニューの文言', placeholder: '私たちについて' },
  nav_seminars: { label: 'ヘッダーナビ：セミナー', desc: 'ヘッダーメニューの文言', placeholder: 'セミナー' },
  nav_publications: { label: 'ヘッダーナビ：刊行物', desc: 'ヘッダーメニューの文言', placeholder: '刊行物' },
  nav_information: { label: 'ヘッダーナビ：各種情報', desc: 'ヘッダーメニューの文言', placeholder: '各種情報' },
  nav_membership: { label: 'ヘッダーナビ：入会案内', desc: 'ヘッダーメニューの文言', placeholder: '入会案内' },
  nav_premium_benefits: { label: 'ヘッダーナビ：プレミアム特典', desc: 'ヘッダーメニューの文言', placeholder: 'プレミアム会員の特典' },
  nav_news: { label: 'ヘッダーナビ：お知らせ', desc: 'ヘッダーメニューの文言', placeholder: 'お知らせ' },
  nav_company: { label: 'ヘッダーナビ：会社概要', desc: 'ヘッダーメニューの文言', placeholder: '会社概要' },
  nav_faq: { label: 'ヘッダーナビ：よくある質問', desc: 'ヘッダーメニューの文言', placeholder: 'よくある質問' },
  nav_indicators: { label: 'ヘッダードロップダウン：経済指標', desc: 'サブメニューの文言', placeholder: '経済指標' },
  nav_statistics: { label: 'ヘッダードロップダウン：経済・調査統計', desc: 'サブメニューの文言', placeholder: '経済・調査統計' },
  nav_membership_standard: { label: 'ヘッダードロップダウン：スタンダード', desc: 'サブメニューの文言', placeholder: 'スタンダード' },
  nav_membership_premium: { label: 'ヘッダードロップダウン：プレミアム', desc: 'サブメニューの文言', placeholder: 'プレミアム' },
  link_home: { label: 'フッターナビ：トップページ', desc: 'フッターメニューの文言', placeholder: 'トップページ' },
  link_company: { label: 'フッターナビ：会社概要', desc: 'フッターメニューの文言', placeholder: '会社概要' },
  link_about: { label: 'フッターナビ：私たちについて', desc: 'フッターメニューの文言', placeholder: '私たちについて' },
  link_news: { label: 'フッターナビ：お知らせ', desc: 'フッターメニューの文言', placeholder: 'お知らせ' },
  link_faq: { label: 'フッターナビ：よくある質問', desc: 'フッターメニューの文言', placeholder: 'よくある質問' },
  link_contact: { label: 'フッターナビ：お問い合わせ', desc: 'フッターメニューの文言', placeholder: 'お問い合わせ' },
  link_seminar: { label: 'フッターナビ：セミナー', desc: 'フッターメニューの文言', placeholder: 'セミナー' },
  link_publication: { label: 'フッターナビ：刊行物', desc: 'フッターメニューの文言', placeholder: '刊行物' },
  link_glossary: { label: 'フッターナビ：用語集', desc: 'フッターメニューの文言', placeholder: '用語集' },
  link_membership: { label: 'フッターナビ：入会案内', desc: 'フッターメニューの文言', placeholder: '入会案内' },
  link_membership_standard: { label: 'フッターナビ：スタンダード', desc: 'フッターメニューの文言', placeholder: 'スタンダード' },
  link_membership_premium: { label: 'フッターナビ：プレミアム', desc: 'フッターメニューの文言', placeholder: 'プレミアム' },
  link_cri_consulting: { label: 'フッターナビ：CRI経営コンサルティング', desc: 'フッターメニューの文言', placeholder: 'CRI 経営コンサルティング' },
  link_member_login: { label: 'フッターナビ：会員ログイン', desc: 'フッターメニューの文言', placeholder: '会員ログイン' },
  link_legal: { label: 'フッターナビ：特定商取引法', desc: 'フッターメニューの文言', placeholder: '特定商取引法に関する表記' },
  link_privacy: { label: 'フッターナビ：プライバシーポリシー', desc: 'フッターメニューの文言', placeholder: 'プライバシーポリシー' },
  link_terms: { label: 'フッターナビ：利用規約', desc: 'フッターメニューの文言', placeholder: '利用規約' },
  link_sitemap: { label: 'フッターナビ：サイトマップ', desc: 'フッターメニューの文言', placeholder: 'サイトマップ' },
}
...
const KEY_LOCATIONS = {
  ...
  'contact': {
    ...
    form_label_subject: 'フォーム項目：件名ラベル',
    form_placeholder_select: 'フォーム項目：選択肢の初期表示',
    ...
    form_label_name: 'フォーム項目：お名前ラベル',
    form_label_kana: 'フォーム項目：ふりがなラベル',
    form_label_company: 'フォーム項目：会社名ラベル',
    form_label_position: 'フォーム項目：役職ラベル',
    form_label_phone: 'フォーム項目：電話番号ラベル',
    form_label_email: 'フォーム項目：メールアドレスラベル',
    form_label_content: 'フォーム項目：お問い合わせ内容ラベル',
    form_privacy_note: '規約案内文（チェックボックス上部）',
    form_privacy_agree: '規約同意チェックのラベル',
    form_button_confirm: '送信ボタン文言',
  },
  'membership-application': {
    page_title: 'ヒーロー・パンくず（MembershipApplicationFormPage）',
    page_subtitle: '英字のサブ見出し（MembershipApplicationFormPage）',
    form_title: 'フォームの大見出し（MembershipApplicationFormPage）',
    form_label_subject: 'フォーム項目：会員タイプラベル',
    form_placeholder_select: 'フォーム項目：選択肢の初期表示',
    ...
    form_label_phone: 'フォーム項目：電話番号ラベル',
    form_label_email: 'フォーム項目：メールアドレスラベル',
    form_label_content: 'フォーム項目：入会希望内容ラベル',
    terms_article2_title: '規約見出し：第2条（会員）',
    terms_article2_body: '規約本文：第2条（会員）',
    terms_article3_title: '規約見出し：第3条（会員種別・サービス）',
    terms_article3_intro: '規約導入文：第3条',
    standard_title: '規約セクション見出し：スタンダード会員',
    standard_item1: '規約項目：スタンダード①',
    standard_item2: '規約項目：スタンダード②',
    standard_item3: '規約項目：スタンダード③',
    standard_item4: '規約項目：スタンダード④',
    premium_title: '規約セクション見出し：プレミアム会員',
    premium_intro: '規約導入文：プレミアム会員',
    premium_item5: '規約項目：プレミアム⑤',
    premium_item6: '規約項目：プレミアム⑥',
    premium_item7: '規約項目：プレミアム⑦',
    terms_download_label: '規約PDFダウンロードリンク文言',
    form_privacy_note: '規約案内文（チェックボックス上部）',
    form_privacy_agree: '規約同意チェックのラベル',
    form_button_confirm: '送信ボタン文言',
  },
  'seminar-application': {
    page_title: 'ヒーロー・パンくず（SeminarApplicationFormPage）',
    page_subtitle: '英字のサブ見出し（SeminarApplicationFormPage）',
    form_title: 'フォームの大見出し（SeminarApplicationFormPage）',
    form_label_subject: 'フォーム項目：会員タイプラベル',
    form_placeholder_select: 'フォーム項目：選択肢の初期表示',
    form_option_standard: '選択肢：スタンダード会員',
    form_option_premium: '選択肢：プレミアムネット会員',
  ...
  navigation: {
    ...
    nav_faq: 'ヘッダー：よくある質問',
    nav_indicators: 'ヘッダードロップダウン：経済指標',
    nav_statistics: 'ヘッダードロップダウン：経済・調査統計',
    nav_membership_standard: 'ヘッダードロップダウン：スタンダード会員',
    nav_membership_premium: 'ヘッダードロップダウン：プレミアム会員',
  },
  footer: {
